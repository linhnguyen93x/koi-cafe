...
import { View, Text, Image, StyleSheet, TouchableNativeFeedback, Dimensions, TouchableOpacity } from 'react-native'
...
class EmployeeMenu extends Component {
	...
	render() {
		...
		return <Image style={[styles.container, globalStyle.imgContainer, globalStyle.mainPaddingTop]}
			...
			<View style={[styles.contentSection]}>
				<Image
					...
					style={styles.logo} />
				<Text style={styles.name}>{this.props.item.get('HoTen').toUpperCase()}</Text>
